...
class AnimationStore:
    ...
    def red_bird(self):
        return SequenceAnimation([Keyframe(self.textures.image('redbird-downflap.png'), 0.1),
    ...
    def yellow_bird(self):
        return SequenceAnimation([Keyframe(self.textures.image('yellowbird-downflap.png'), 0.1),
                                  Keyframe(self.textures.image('yellowbird-midflap.png'), 0.2),
                                  Keyframe(self.textures.image('yellowbird-upflap.png'), 0.1)])

    def blue_bird(self):
        return SequenceAnimation([Keyframe(self.textures.image('bluebird-downflap.png'), 0.1),
